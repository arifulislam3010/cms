          ...
          <div v-for="(post,index) in sposts.data" :key="index">
            ...
            <div class="blog-posts-area">
              ...
              <div class="single-blog-post featured-post single-post">
                  <nav aria-label="breadcrumb" style="margin-bottom: 35px;">
                        <ol class="breadcrumb">
                ...
                <div class="post-data">
                  ...
                  <div class="post-meta">
                    ...
                    <p>
                      Donec turpis erat, scelerisque id euismod sit amet,
                      fermentum vel dolor. Nulla facilisi. Sed pellentesque
                      lectus et accu msan aliquam. Fusce lobortis cursus quam,
                      id mattis sapien. Aliquam erat volutpat. Aliquam placerat,
                      est quis sagi ttis tincidunt, ipsum eros posuere mi, ut
                      finibus quam sem eget ex. Interdum et malesuada fames ac
                      ante ipsum pr imis in faucibus. Donec commodo quis enim ac
                      auctor. Ut et mollis felis, sit amet ultricies est.
                      Suspendisse sed faucibus tortor.
                    </p>
                    <div
                    ...
                    >
                      ...
                      >
                        <a href="#" class="post-like"
                          ><img src="@/assets/images/core-img/like.png" alt="" />
                          <span>392</span></a
                        >
                        <a href="#" class="post-comment"
                          ><img src="@/assets/images/core-img/chat.png" alt="" />
                          <span>10</span></a
                        >
                      </div>
                    </div>
              ...
              <div class="blog-post-author d-flex">
                <div class="author-thumbnail">
                  <img src="@/assets/images/bg-img/32.jpg" alt="" />
                </div>
                <div class="author-info">
                  <a href="#" class="author-name"
                    >James Smith, <span>The Author</span></a
                  >
                  <p>
                    Donec turpis erat, scelerisque id euismod sit amet,
                    ...
                    <div class="post-data">
                      ...
                      <a href="#" class="post-title">
                        <h6>
                          ...
                          metus sit amet odio sodales placer. Sed varius leo
                          ac...
                        </h6>
                      </a>
                ...
                <ol>
                  ...
                  <li class="single_comment_area">
                    ...
                    <div class="comment-content d-flex">
                      ...
                      <div class="comment-author">
                        <img src="@/assets/images/bg-img/30.jpg" alt="author" />
                      </div>
                      <!-- Comment Meta -->
                    ...
                    <ol class="children">
                      <li class="single_comment_area">
                        ...
                        <div class="comment-content d-flex">
                          <!-- Comment Author -->
                          <div class="comment-author">
                            <img src="@/assets/images/bg-img/31.jpg" alt="author" />
                          </div>
                          <!-- Comment Meta -->
                          <div class="comment-meta">
                  ...
                  <li class="single_comment_area">
                    ...
                    <div class="comment-content d-flex">
                      <!-- Comment Author -->
                      <div class="comment-author">
                        <img src="@/assets/images/bg-img/32.jpg" alt="author" />
                      </div>
                      <!-- Comment Meta -->
                      <div class="comment-meta">
                        <a href="#" class="post-author">Christian Williams</a>
                ...
                <div class="single-blog-post small-featured-post d-flex">
                  ...
                  <div class="post-data">
                    ...
                    <div class="post-meta">
                      <a href="#" class="post-title">
                        <h6>
                          Sed a elit euismod augue semper congue sit amet ac
                          sapien.
                        </h6>
                      </a>
                      <p class="post-date">
              ...
              <div class="latest-comments-widget">
                ...
                <div class="single-comments d-flex">
                  <div class="comments-thumbnail mr-15">
                    <img src="@/assets/images/bg-img/29.jpg" alt="" />
                  </div>
                  <div class="comments-text">
                    <a href="#"
                      >Jamie Smith <span>on</span> Facebook is offering facial
                      recognition...</a
                    >
