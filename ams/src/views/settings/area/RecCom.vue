<template>
  <div>
    <div class="card">
      {{ node.label}}
      <div>
        <a href="#" @click="editAreaModal(node)" style="margin-right:30px; color:green">Update</a>
        <a href="#" @click="addChild(node)" style="margin-right:30px; color:#000099">AddChild</a>
        <a href="#" @click="deleteArea(node.id)" style="margin-right:30px; color:red">Delete</a>
        <a
          href="#"
